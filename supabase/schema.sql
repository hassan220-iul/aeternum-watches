...
create table if not exists store_settings (
  ...
  whish_money_name text not null default 'Aeternum Watches',
  whish_money_phone text not null default '+961 70 674 606',
  updated_at timestamptz not null default now()
);
...
update store_settings set whish_money_name = 'Aeternum Watches' where whish_money_name = '';
update store_settings set whish_money_phone = '+961 70 674 606' where whish_money_phone = '';
