  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (result?.session === null) {
        // Supabase project has "Confirm email" turned on — the account was
        // created for real, but there's no active session yet until the
        // shopper clicks the link Supabase just emailed them.
