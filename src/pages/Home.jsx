...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Direct link to the admin dashboard for demo/testing convenience.
          Access is still gated by AdminLayout's isAdmin check + Supabase
          RLS — this button just makes it easy to find on the index page.
          Consider removing it from the public homepage before a real
          launch and linking to /admin from an internal tool instead. */}
