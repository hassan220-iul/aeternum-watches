...
// Real deployments should drop an .mp4 into /public and reference it here
// via <video autoPlay muted loop playsInline> in place of .hero__backdrop's
// gradient + grain treatment (no stock footage is bundled in this build).
